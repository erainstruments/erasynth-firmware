...
uint16_t _staModeSSID[]				= { _waveformType[0] + _waveformType[1],20 };
uint16_t _apModeSSID[]				= { _staModeSSID[0] + _staModeSSID[1],20 };
uint16_t _staModePassword[]			= { _apModeSSID[0] + _apModeSSID[1],20};
uint16_t _apModePassword[]			= { _staModePassword[0] + _staModePassword[1],20};
...
uint16_t _ampCalStart[]				= { _subnetAddress[0] + _subnetAddress[1],0 };
